<#Modified by  : Elias Moioli
<#Author       : Akash Chawla
# Usage        : Custom Windows optimizations for AVD
#>

#############################################
#         Custom Windows optimizations             #
#############################################
...
$Optimizations =@('WindowsMediaPlayer','ScheduledTasks','DefaultUserSettings','Autologgers','Services','NetworkOptimizations','LGPO','DiskCleanup')
